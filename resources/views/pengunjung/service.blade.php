            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;"
                        id="prosedur_pelayanan">
                        <p class="d-inline-block border rounded-pill py-1 px-4">Prosedur</p>
                        <h1 class="mb-4">Informasi Prosedur Pelayanan</h1>
                        <p class="mb-0">Untuk memastikan kelancaran pelayanan, berikut adalah beberapa informasi penting
                            mengenai prosedur dan persyaratan yang perlu Anda ketahui sebelum berkunjung ke Puskesmas
                            Banjarwangi.</p>
                    </div>
                    <div class="row g-4 justify-content-center">
                        <div class="col-lg-10"> {{-- Lebarkan kolom agar daftar terlihat bagus --}}
                            ...
                            <div class="row g-3"> {{-- Gunakan row untuk membuat daftar dalam grid --}}
                                ...
                                <div class="col-sm-6"> {{-- Setiap item menjadi kolom responsif --}}
                                    <div class="d-flex align-items-start border rounded p-3 h-100"> {{-- Item border, padding, height --}}
                                        <i class="fas fa-address-book text-primary me-3 pt-1 fs-5"></i>
                                        {{-- Icon KTP --}}
                                        <p class="mb-0">Kartu Keluarga (KK).</p>
                                    </div>
                                </div>
                                {{-- <div class="col-sm-6">
                        <div class="d-flex align-items-start border rounded p-3 h-100">
                            <i class="fas fa-handshake text-primary me-3 pt-1 fs-5"></i> 
                            <p class="mb-0">Kartu BPJS Kesehatan / Kartu Indonesia Sehat (KIS) bagi peserta JKN.</p>
                        </div>
                    </div> --}}
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-start border rounded p-3 h-100">
                                        <i class="fas fa-address-card text-primary me-3 pt-1 fs-5"></i>
                                        {{-- Icon Kartu Berobat --}}
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-start border rounded p-3 h-100">
                                        ...
                                        <p class="mb-0">Surat Rujukan dari fasilitas kesehatan lain (jika diperlukan).
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 justify-content-center"> {{-- Gunakan row untuk menata tombol --}}
                                <div class="col-sm-6 col-md-4"> {{-- Kolom untuk tombol online --}}
                                    <a href="{{ asset('home/img/pendaftaran_online.png') }}"
                                        data-lightbox="alur-pendaftaran" class="btn btn-info w-100 py-3 rounded">
                                        <i class="fas fa-cloud-upload-alt me-2"></i> Alur Pendaftaran Online
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4"> {{-- Kolom untuk tombol offline --}}
                                    <a href="{{ asset('home/img/pendaftaran_offline.png') }}"
                                        data-lightbox="alur-pendaftaran" class="btn btn-success w-100 py-3 rounded">
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;"
                        ...
                        <p class="mb-0">Puskesmas Banjarwangi berkomitmen menyediakan akses layanan kesehatan yang
                            terjangkau bagi seluruh lapisan masyarakat. Berikut adalah informasi terkait biaya pelayanan:
                        </p>
                    </div>
                    <div class="row g-4 justify-content-center">
                        <div class="col-lg-10"> {{-- Lebarkan kolom agar daftar terlihat bagus --}}
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="d-flex align-items-start border rounded p-3 bg-light h-100">
                                        {{-- Gunakan bg-light atau bg-white --}}
                                        <i class="fas fa-id-card-alt text-primary me-3 pt-1 fs-5"></i>
                                        <div>
                                            <p class="mb-0"><strong>Bagi Peserta Jaminan Kesehatan Nasional (JKN) / BPJS
                                                    Kesehatan:</strong> Pelayanan adalah <strong>GRATIS</strong> sesuai
                                                dengan prosedur dan ketentuan yang berlaku.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex align-items-start border rounded p-3 bg-light h-100">
                                        ...
                                        <div>
                                            <p class="mb-0"><strong>Bagi Pasien Umum (Non-BPJS Kesehatan):</strong> Biaya
                                                pelayanan akan dikenakan sesuai dengan Peraturan Daerah (Perda) yang
                                                berlaku. Rincian biaya dapat ditanyakan langsung di loket pendaftaran atau
                                                bagian informasi.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex align-items-start border rounded p-3 bg-light h-100">
                                        ...
                                        <div>
                                            <p class="mb-0">Kami selalu mengedepankan transparansi dalam setiap transaksi
                                                pelayanan. Informasi lebih lanjut dapat ditanyakan pada petugas kami.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
